...
#define SEG3_GPU_DVFS_FREQ1			(450000)	/* KHz */
#define SEG3_GPU_DVFS_FREQ2			(300000)	/* KHz */

#define SEG3_GPU_DVFS_VOLT0			(79000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT1			(68000)		/* mV x 100 */
#define SEG3_GPU_DVFS_VOLT2			(63000)		/* mV x 100 */
